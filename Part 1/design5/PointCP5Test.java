...
/**
 * This class prompts the user for a set of coordinates, and then displays both cartesian 
 * and polar representations. Based on class PointCPTest.
 *
...
public class PointCP5Test {
	...
	public static void main(String[] args) {
		...
		System.out.println("\nThe coordinates in Cartesian are:(\n" + point.getX() +"," + point.getY()+")");
		System.out.println("\nThe coordinates in Polar are:(\n" + point.getRho() +"," + point.getTheta()+")");
	}
